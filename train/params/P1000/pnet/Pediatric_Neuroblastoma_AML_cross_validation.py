...
selected_genes = 'Pediatric_Neuroblastoma_AML_genes.csv'
data_base = {'id': 'ALL', 'type': 'prostate_paper',
             'params': {
                 ...
                 'training_split': 'Pediatric_Neuroblastoma_AML',
             }
             }
data = [data_base]
...
pipeline = {'type': 'crossvalidation', 'params': {'save_train': True, 'n_splits': 5}}
